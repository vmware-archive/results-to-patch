...
var iterationOverridesLens = R.lensProp('iteration_overrides');
...
var iterationOverrideLens = function(iterationOverridesIndex) {
  return R.compose(
    iterationOverridesLens,
...
function updateIterationOverride(state, action) {
  ...
  if (iterationOverrideIndex !== -1) {
    return R.over(
      iterationOverrideLens(iterationOverrideIndex),
      R.merge(R.__, action.attrs),
      state
    );
  } else {
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case reducer.MOVE_STORIES:              return moveStories(state, action);
    ...
    case reducer.UPDATE_ITERATION_OVERRIDE: return updateIterationOverride(state, action);
    case reducer.DELETE_ITERATION_OVERRIDE: return deleteIterationOverride(state, action);
    default:                                return state;
  }
}

reducer.UPDATE_VERSION            = Object.freeze({type: 'UPDATE_VERSION'});
reducer.DELETE_STORY              = Object.freeze({type: 'DELETE_STORY'});
reducer.CREATE_STORY              = Object.freeze({type: 'CREATE_STORY'});
reducer.UPDATE_STORY              = Object.freeze({type: 'UPDATE_STORY'});
reducer.MOVE_STORIES              = Object.freeze({type: 'MOVE_STORIES'});
reducer.DELETE_TASK               = Object.freeze({type: 'DELETE_TASK'});
reducer.CREATE_TASK               = Object.freeze({type: 'CREATE_TASK'});
reducer.MOVE_TASK                 = Object.freeze({type: 'MOVE_TASK'});
reducer.UPDATE_TASK               = Object.freeze({type: 'UPDATE_TASK'});
reducer.DELETE_COMMENT            = Object.freeze({type: 'DELETE_COMMENT'});
reducer.DELETE_EPIC               = Object.freeze({type: 'DELETE_EPIC'});
reducer.CREATE_EPIC               = Object.freeze({type: 'CREATE_EPIC'});
reducer.UPDATE_EPIC               = Object.freeze({type: 'UPDATE_EPIC'});
reducer.CREATE_LABEL              = Object.freeze({type: 'CREATE_LABEL'});
reducer.UPDATE_LABEL              = Object.freeze({type: 'UPDATE_LABEL'});
reducer.CREATE_COMMENT            = Object.freeze({type: 'CREATE_COMMENT'});
reducer.UPDATE_COMMENT            = Object.freeze({type: 'UPDATE_COMMENT'});
reducer.UPDATE_ITERATION_OVERRIDE = Object.freeze({type: 'UPDATE_ITERATION_OVERRIDE'});
reducer.DELETE_ITERATION_OVERRIDE = Object.freeze({type: 'DELETE_ITERATION_OVERRIDE'});
