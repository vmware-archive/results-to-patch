...
Project.prototype.appendCommentFileAttachment = function(id, faId, index) {
  var path = this.pathOfComment(id) + '/file_attachments/' + index;
...
Project.prototype.hasCommentFileAttachment = function(id, faId) {
  return !!_.findWhere(this.get(this.pathOfComment(id)).file_attachments, {id: faId});
};
