...
// STORY COMMENT
Project.prototype.deleteStoryComment = function(id) {
  this.opRemove(this.pathOfStoryComment(id));
};
...
Project.prototype.appendEpicComment = function(epicId, id) {
  var commentsPath = this.pathOfEpic(epicId) + '/comments';
  var lastIndex = this.get(commentsPath).length;
  var path = commentsPath + '/' + lastIndex;
...
Project.prototype.appendStoryCommentFileAttachment = function(id, faId, index) {
  var path = this.pathOfStoryComment(id) + '/file_attachments/' + index;
  this.opAdd(path, {id: faId});
};

Project.prototype.appendGoogleAttachment = function(id, gaId, index) {
  var path = this.pathOfComment(id) + '/google_attachments/' + index;
  this.opAdd(path, {id: gaId});
};
...
Project.prototype.setEpicCommentAttr = function(id, attr, value) {
  this.setPathAttr(this.pathOfEpicComment(id) + '/' + attr, value);
};

// EPIC COMMENT
Project.prototype.deleteEpicComment = function(id) {
  this.opRemove(this.pathOfEpicComment(id));
};
...
Project.prototype.moveEpicBefore = function(id, beforeId) {
  ...
  var beforeIndex = this.indexOfEpic(beforeId);
...
Project.prototype.moveEpicAfter = function(id, afterId) {
  var index = this.indexOfEpic(id);
  var beforeIndex = this.indexOfEpic(afterId) + 1;
...
Project.prototype.pathOfFileAttachment = function(id) {
  ...
  for (var i = 0; i < stories.length; i++) {
    ...
    for (var j = 0; j < comments.length; j++) {
      ...
      for (var k = 0; k < fileAttachments.length; k++) {
        if (fileAttachments[k].id === id) {
          return paths.storyCommentFileAttachment(i, j, j);
        }
      }
    }
  }
  ...
  for (var m = 0; m < epics.length; m++) {
    ...
    for (var n = 0; n < comments.length; n++) {
      ...
      for (var o = 0; o < fileAttachments.length; o++) {
        if (fileAttachments[k].id === id) {
          return paths.epicCommentFileAttachment(i, j, j);
        }
      }
    }
  }
...
Project.prototype.pathOfGoogleAttachment = function(id) {
  ...
  for (var i = 0; i < stories.length; i++) {
    ...
    for (var j = 0; j < comments.length; j++) {
      ...
      for (var k = 0; k < googleAttachments.length; k++) {
        if (googleAttachments[k].id === id) {
          return paths.storyCommentGoogleAttachment(i, j, j);
        }
      }
    }
  }
  ...
  for (var m = 0; m < epics.length; m++) {
    ...
    for (var n = 0; n < comments.length; n++) {
      ...
      for (var o = 0; o < googleAttachments.length; o++) {
        if (googleAttachments[k].id === id) {
          return paths.epicCommentGoogleAttachment(i, j, j);
        }
      }
    }
  }
...
Project.prototype.hasStoryCommentFileAttachment = function(id, faId) {
  return !!_.findWhere(this.get(this.pathOfStoryComment(id)).file_attachments, {id: faId});
};
