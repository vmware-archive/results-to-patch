module.exports = {
  ...
  storyFollower: function(storyIndex, followerIndex) {
    return '/stories/' + storyIndex +'/follower_ids/' + followerIndex;
  },
  ...
  epicFollower: function(epicIndex, followerIndex) {
    return '/epics/' + epicIndex +'/follower_ids/' + followerIndex;
  },
